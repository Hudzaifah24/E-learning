...
>
    <div class="container">
        <div class="">
            ...
            <p class="dashboard-subtitle">Edit Subjects</p>
        </div>
            ...
            <div class="p-5 bg-white shadow-lg rounded-xl">
                <form action="" class="grid grid-cols-6 gap-5">
                    <div class="flex flex-col col-span-6">
                        ...
                        <div class="">
                            <input type="text" value="{{ $subjects->name }}" class="w-1/2 p-2 text-gray-500 border border-black rounded focus:text-black">
                        </div>
                    </div>
                    <div class="flex flex-col col-span-6">
                        <div class="mb-2">
                        ...
                        <div class="">
                            <input type="text" value="{{ $subjects->photo }}" class="w-full p-2 text-gray-500 border border-black rounded focus:text-black">
                        </div>
                    ...
                    <div class="flex flex-col col-span-6">
                        ...
                        <div class="">
                            <textarea class="" name="editor" id="" cols="30" rows="10">{{ $subjects->description }}</textarea>
                        </div>
                    </div>
